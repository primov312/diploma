...
public class ItemSummary {
  ...
  */
  ...
  public ItemSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public ItemSummary quantity(Integer quantity) {
  ...
  */
  ...
  public ItemSummary price(BigDecimal price) {
    this.price = price;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sku, itemSummary.sku) &&
        Objects.equals(this.name, itemSummary.name) &&
        Objects.equals(this.quantity, itemSummary.quantity) &&
